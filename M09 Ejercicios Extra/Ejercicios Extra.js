...
function asAmirror(frase) {
   ...
   let words = frase.split(" "); // Dividir la frase en un array de palabras
   let reversedWords = words.map(word => word.split("").reverse().join("")); // Invertir cada palabra

   return reversedWords.join(" "); // Unir las palabras invertidas en un nuevo string
}
